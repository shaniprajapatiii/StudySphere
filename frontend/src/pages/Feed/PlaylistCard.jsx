...
export default function PlaylistCard({ playlist, onClick }) {
  ...
  return (
    <div
      className="group cursor-pointer overflow-hidden ds-card-interactive"
      onClick={onClick}
    ...
    >
      ...
      <div className="relative aspect-video overflow-hidden theme-bg-surface-2">
        ...
        <div className="absolute top-0 bottom-0 right-0 w-1/3 bg-black/65 backdrop-blur-sm flex flex-col items-center justify-center text-white">
      ...
      <div className="p-4">
        {/* Title */}
        <h3
          className="font-semibold text-sm line-clamp-2 mb-2 group-hover:text-green-700 ds-fade-in transition-colors duration-200 theme-text-primary"
