    ...
    <div className="min-h-screen theme-bg-base theme-text-primary overflow-hidden">
      ...
      <div className="theme-bg-base py-24 sm:py-32 px-6 border-b theme-border relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-green-600/10 px-5 py-2 rounded-full text-green-600 dark:text-green-400 text-xs font-extrabold uppercase tracking-widest mb-8 border border-green-600/20 shadow-sm">
            ...
            <span className="text-green-600 dark:text-green-400">Intelligent Education</span>
          </h1>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 animate-in slide-in-from-right duration-1000">
            <div className="theme-bg-surface p-8 rounded-[32px] border theme-border shadow-sm hover:shadow-xl transition-all group">
              <div className="w-14 h-14 bg-green-600/10 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="theme-text-secondary text-lg sm:text-xl font-medium leading-relaxed">
              ...
              <span className="font-extrabold text-green-600 dark:text-green-400 uppercase tracking-widest text-sm bg-green-600/5 px-3 py-1 rounded-full border border-green-600/10 ml-1">Engagement</span>
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-10">
              {[
              {
                icon: <BookOpen className="w-7 h-7 text-green-600 dark:text-green-400" />,
              ...
              {
                icon: <Brain className="w-7 h-7 text-green-600 dark:text-green-400" />,
              ...
              <div
                ...
                <div className="w-14 h-14 bg-green-600/5 rounded-2xl flex items-center justify-center mb-8 shadow-inner border border-green-600/10">
                  {item.icon}
                </div>
      ...
      <div className="py-24 sm:py-32 px-6 theme-bg-base text-center">
        <div className="max-w-4xl mx-auto relative overflow-hidden rounded-[56px] theme-bg-surface theme-border border p-12 sm:p-20 shadow-2xl">
           <div className="absolute -top-24 -right-24 w-64 h-64 bg-green-600/10 blur-[100px] rounded-full" />
           <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-green-600/10 blur-[100px] rounded-full" />
           ...
           <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Link
                  to="/feed"
                  className="ds-btn-primary px-10 py-4 font-extrabold shadow-xl shadow-green-900/10 text-lg"
                >
                  Start Learning Now
                </Link>
                <Link
