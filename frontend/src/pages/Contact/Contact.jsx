  ...
  return (
    <div className="min-h-screen theme-bg-base pt-32 pb-24 px-4 sm:px-6 lg:px-8 font-sans overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
        <div className="absolute top-0 right-0 w-96 h-96 bg-green-600/10 blur-[120px] rounded-full -mr-48 -mt-48 pointer-events-none" />
        
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 bg-green-600/10 px-4 py-1.5 rounded-full text-green-600 dark:text-green-400 text-[10px] font-extrabold uppercase tracking-[0.2em] mb-6 border border-green-600/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-5 theme-bg-surface rounded-[48px] shadow-sm p-10 sm:p-12 theme-border border flex flex-col h-full">
            ...
            <div className="space-y-8 mb-16 flex-1">
              <div className="flex items-start group">
                <div className="w-14 h-14 rounded-2xl bg-green-600/10 flex items-center justify-center flex-shrink-0 mr-6 border border-green-600/20 group-hover:scale-110 transition-transform">
              ...
              <div className="flex items-start group">
                ...
                <div>
                   ...
                   <a
                    ...
                    className="text-lg font-bold theme-text-primary hover:text-green-700 transition-colors"
                  >
                    +91 6307527950
                  </a>
                </div>
              ...
              <div className="flex items-start group">
                ...
                <div>
                   ...
                   <a
                    ...
                    className="text-lg font-bold theme-text-primary hover:text-green-700 transition-colors truncate block"
                  >
            ...
            <div className="pt-10 border-t theme-border">
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  ...
                  className="w-12 h-12 rounded-2xl theme-bg-surface-2 flex items-center justify-center theme-text-secondary hover:bg-green-700 hover:text-white transition-all duration-500 border theme-border"
                  title="GitHub"
                >
                  <Github size={20} />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 rounded-2xl theme-bg-surface-2 flex items-center justify-center theme-text-secondary hover:bg-green-600 hover:text-white transition-all duration-500 border theme-border"
                  title="LeetCode"
                >
                  <Code size={20} />
                </a>
          ...
          <div className="lg:col-span-7 theme-bg-surface rounded-[48px] shadow-2xl p-10 sm:p-14 theme-border border relative">
            <div className="absolute top-10 right-10 opacity-5">
              <Send size={120} className="text-green-600" />
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
              ...
              <button
                type="submit"
                className="w-full bg-green-700 text-white font-extrabold py-5 px-8 rounded-[24px] hover:bg-green-600 hover:shadow-2xl hover:shadow-green-900/20 transition-all duration-500 flex items-center justify-center gap-3 shadow-xl shadow-green-900/10 group"
              >
