  ...
  return (
    <div className="min-h-screen bg-slate-950 py-12 px-4">
      <div className="max-w-4xl mx-auto bg-slate-900 rounded-lg shadow-sm p-8 border border-slate-800">
        <h1 className="ds-h1 mb-6">Terms of Service</h1>
        ...
        <div className="space-y-6 text-slate-300">
          <section>
            <h2 className="ds-h3 mb-3">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="ds-h3 mb-3">2. Description of Service</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="ds-h3 mb-3">3. User Accounts</h2>
            <h3 className="ds-h4 mb-2 mt-4">3.1 Account Creation</h3>
            <p className="mb-3">
            ...
            <h3 className="ds-h4 mb-2 mt-4">3.2 Account Security</h3>
            <p>
          ...
          <section>
            <h2 className="ds-h3 mb-3">4. User Conduct</h2>
          ...
          <section>
            <h2 className="ds-h3 mb-3">5. Intellectual Property</h2>
            <h3 className="ds-h4 mb-2 mt-4">5.1 Platform Content</h3>
            <p className="mb-3">
            ...
            <h3 className="ds-h4 mb-2 mt-4">5.2 User Content</h3>
            <p className="mb-3">
            ...
            <h3 className="ds-h4 mb-2 mt-4">5.3 YouTube Content</h3>
            <p>
          ...
          <section>
            <h2 className="ds-h3 mb-3">6. AI-Generated Content</h2>
            <p>
          ...
          <section>
            <h2 className="ds-h3 mb-3">7. Third-Party Services</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="ds-h3 mb-3">8. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="ds-h3 mb-3">9. Service Availability</h2>
            <p>
          ...
          <section>
            <h2 className="ds-h3 mb-3">10. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="ds-h3 mb-3">11. Modifications to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="ds-h3 mb-3">12. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="ds-h3 mb-3">13. Contact Information</h2>
            <p className="mb-3">
              If you have any questions about these Terms of Service, please contact us:
            </p>
            <ul className="space-y-1 ml-4">
              <li><strong>Email:</strong> support@studysphere.com</li>
              <li><strong>Contact Form:</strong> <a href="/contact" className="text-emerald-600 hover:text-emerald-700 underline">Contact Page</a></li>
            </ul>
          </section>
