  ...
  if (authLoading) {
    return (
      <div className="flex items-center justify-center min-h-[60vh] px-4 theme-bg-base">
          ...
          <div className="animate-spin rounded-full h-6 w-6 border-2 border-green-600/30 border-t-green-600"></div>
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[80vh] p-4 sm:p-8 theme-bg-base">
        <div className="w-full max-w-lg rounded-[40px] theme-border border theme-bg-surface shadow-2xl overflow-hidden">
          <div className="h-32 bg-linear-to-r from-green-600 via-green-500 to-green-600 relative">
          ...
          <div className="pt-16 px-8 pb-10 text-center">
            ...
            <button
              ...
              className="w-full py-4 px-6 bg-green-600 hover:bg-green-500 text-white font-extrabold rounded-2xl transition-all shadow-xl flex items-center justify-center gap-3 group"
            >
               <img
    ...
    <div className="min-h-screen theme-bg-base py-8 sm:py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        <div className="relative overflow-hidden rounded-[48px] theme-border border theme-bg-surface shadow-2xl">
          {/* Cover Area */}
          <div className="absolute inset-x-0 top-0 h-56 bg-linear-to-r from-green-600 via-green-500 to-green-600" />
          ...
          <div className="relative px-6 sm:px-10 pt-10 pb-6">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
              <div className="flex flex-col sm:flex-row sm:items-end gap-6">
                  ...
                  <div className="absolute -inset-4 rounded-full bg-green-600/10 blur-2xl" />
                  <img
                    src={user.picture}
                    alt="profile"
                  ...
                  <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight flex items-center gap-4 theme-text-primary">
                    ...
                    {!isEditing && (
                        <button
                            ...
                            className="inline-flex h-12 w-12 items-center justify-center rounded-2xl theme-bg-surface-2 theme-border border theme-text-secondary hover:text-green-500 hover:theme-bg-surface transition-all shadow-sm"
                            title="Edit Profile"
                          >
                        <Edit2 size={18} />
                      </button>
          ...
          <div className="relative px-6 sm:px-10 pb-12 pt-8">
            ...
            <div className="mb-12">
               <div className="flex items-center justify-between mb-6 px-1">
                  ...
                  <button onClick={() => navigate('/dashboard')} className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-green-600 hover:text-green-500 transition-colors">
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="rounded-3xl theme-bg-base border theme-border p-6 shadow-sm hover:shadow-md transition-shadow group">
                     <div className="w-12 h-12 rounded-2xl bg-green-600/10 text-green-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                        <History size={24} />
                     </div>
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-4 pt-6 border-t theme-border">
                  ...
                  <button
                    type="submit"
                    disabled={isSaving}
                    className="px-8 py-4 rounded-2xl bg-green-600 text-white font-extrabold hover:bg-green-500 transition-all flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed shadow-xl shadow-green-900/10"
                  >
                    {isSaving ? (
                ...
                <div className="rounded-[32px] border theme-border theme-bg-base p-8 shadow-sm group hover:theme-border-green-600/30 transition-all">
                  <h3 className="font-extrabold theme-text-muted text-[10px] uppercase tracking-[0.2em] mb-3">
                    Your Persona
                  </h3>
                  <div className="flex items-center gap-4">
                     <div className="w-10 h-10 rounded-2xl bg-green-600/10 text-green-500 flex items-center justify-center"><Award size={20} /></div>
                ...
                <div className="rounded-[32px] border theme-border theme-bg-base p-8 shadow-sm group hover:theme-border-green-600/30 transition-all">
                  ...
                  <div className="flex items-center gap-4">
                     <div className="w-10 h-10 rounded-2xl bg-green-600/10 text-green-500 flex items-center justify-center"><History size={20} /></div>
                     <p className="text-xl font-extrabold theme-text-primary">
                        {new Date(user.createdAt || user.lastLogin).toLocaleDateString(undefined, {
                        year: "numeric",
                        month: "long",
