  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
          ...
          alt="Profile"
          className="w-9 h-9 rounded-full border-2 border-transparent group-hover:border-green-400 transition-all object-cover shadow-sm"
        />
      </button>
        ...
        >
          {!isAuthenticated ? (
            <button
              ...
              className="w-full text-left px-4 py-2.5 theme-text-secondary flex items-center gap-3 transition-colors text-sm font-medium hover:bg-green-600/10"
            >
            ...
            <>
              ...
              <Link
                ...
                className="w-full text-left px-4 py-2.5 theme-text-secondary flex items-center gap-3 transition-colors text-sm hover:bg-green-600/10"
              >
