          ...
          <div className="flex items-center shrink-0 z-10">
            <a href="/" className="flex items-center">
              <div className="group relative flex items-center gap-3">
                <div className="relative grid place-items-center w-10 h-10 rounded-2xl bg-gradient-to-br from-green-400 via-green-600 to-green-500 shadow-[0_10px_24px_rgba(16,185,129,0.12)] ring-1 ring-green-400/20">
                  ...
                  <span className="absolute -right-1 -top-1 w-3 h-3 rounded-full bg-green-300 ring-2 ring-white/80 shadow-[0_0_12px_rgba(16,185,129,0.28)]" />
                </div>
                <div className="hidden lg:flex flex-col leading-none">
                  ...
                  <span className="text-[1.02rem] font-extrabold tracking-[-0.02em] theme-text-primary mt-0.5">
                    Study
                    <span className="ml-0.5 text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-green-400 to-green-300">
                      Sphere
                    </span>
                  </span>
                </div>
                <span className="sm:hidden font-extrabold text-base tracking-tight theme-text-primary">
                  Study
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-green-400 to-green-300">
                    Sphere
                  </span>
                </span>
              </div>
